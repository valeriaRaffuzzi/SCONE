...
module physicsPackageFactory_func
  ...
  use fixedSourcePhysicsPackageVR_class, only : fixedSourcePhysicsPackageVR
...
contains
  ...
  function new_physicsPackage(dict) result(new)
    ...
    select case(type)
      ...
      case('fixedSourcePhysicsPackageVR')
        allocate( fixedSourcePhysicsPackageVR :: new)

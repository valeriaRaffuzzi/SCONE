...
#line 221 "/home/mskrette/SCONE_cambridge_fork/SCONE/Tallies/TallyClerks/Tests/collisionClerk_test.f90"
  call assertEqual(this % results(i), res, TOL, case // 'BIN : ' //numToChar(i) , &
 & location=SourceLocation( &
 & 'collisionClerk_test.f90', &
 & 221) )
  if (anyExceptions()) return
#line 222 "/home/mskrette/SCONE_cambridge_fork/SCONE/Tallies/TallyClerks/Tests/collisionClerk_test.f90"
    end do
...
#line 231 "/home/mskrette/SCONE_cambridge_fork/SCONE/Tallies/TallyClerks/Tests/collisionClerk_test.f90"
 ...
 & 231) )
  if (anyExceptions()) return
#line 232 "/home/mskrette/SCONE_cambridge_fork/SCONE/Tallies/TallyClerks/Tests/collisionClerk_test.f90"

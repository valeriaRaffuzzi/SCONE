...
#line 225 "/home/mskrette/SCONE_cambridge_fork/SCONE/Tallies/TallyClerks/Tests/collisionClerk_test.f90"
...
#line 229 "/home/mskrette/SCONE_cambridge_fork/SCONE/Tallies/TallyClerks/Tests/collisionClerk_test.f90"
...
#line 235 "/home/mskrette/SCONE_cambridge_fork/SCONE/Tallies/TallyClerks/Tests/collisionClerk_test.f90"
...
!@Test(cases=[1,2,3,4,5,6,7,8])
  subroutine testScoringVirtual(this)
    ...
    do i=1,size(this % bins)
      call mem % getResult(res, this % bins(i))
#line 339 "/home/mskrette/SCONE_cambridge_fork/SCONE/Tallies/TallyClerks/Tests/collisionClerk_test.f90"
  call assertEqual(this % results(i), res, TOL, case // 'BIN : ' //numToChar(i) , &
 & location=SourceLocation( &
 & 'collisionClerk_test.f90', &
 & 339) )
  if (anyExceptions()) return
#line 340 "/home/mskrette/SCONE_cambridge_fork/SCONE/Tallies/TallyClerks/Tests/collisionClerk_test.f90"
    end do

    ! Verify that size of memory returned is correct
#line 343 "/home/mskrette/SCONE_cambridge_fork/SCONE/Tallies/TallyClerks/Tests/collisionClerk_test.f90"
  call assertEqual(size(this % bins), clerk % getSize(), case // 'Memory size test:', &
 & location=SourceLocation( &
 & 'collisionClerk_test.f90', &
 & 343) )
  if (anyExceptions()) return
#line 344 "/home/mskrette/SCONE_cambridge_fork/SCONE/Tallies/TallyClerks/Tests/collisionClerk_test.f90"

    ! Verify that output calls are correct
    call outF % init('dummyPrinter', fatalErrors = .false.)
    call clerk % print (outF, mem)

#line 349 "/home/mskrette/SCONE_cambridge_fork/SCONE/Tallies/TallyClerks/Tests/collisionClerk_test.f90"
  call assertTrue(outF % isValid(), case, &
 & location=SourceLocation( &
 & 'collisionClerk_test.f90', &
 & 349) )
  if (anyExceptions()) return
#line 350 "/home/mskrette/SCONE_cambridge_fork/SCONE/Tallies/TallyClerks/Tests/collisionClerk_test.f90"
